...
supplies = Thing('Architecture Supplies', 'Pens, paper, foamcore, rulers, various boldness pencils, erasers, velum, hotglue, popsicle sticks, rubber bands, miniature plants, people, and furniture.')
...
storage_closet = Place('Closet','A messy, dusty room full of shelves overflowing with pens, paper, foamcore, rulers, and old models. This room is also 10 ft wide.\nThe back wall is 20 ft away, to it\'s left you see a door which seems to be magically free of all the dust and clutter inhabiting the rest of the room.', [supplies])
zendo = Place('Zendo','The room is spacious, forming a 20x20 ft square. The walls to your right and across from you have floor to ceiling windows.\nInside the room, to your left is a lowered 10x10 ft garden.\nBetween the windows and the garden is a 2nd door leading back to the Studio.\nThe wooden floors are completely empty save for a small round cushion sitting on a mat in the corner formed by the widnows.\nIt feels very peaceful here.', [])
