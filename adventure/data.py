...
dining_room = Place('Dining Room','You stand in the middle of a long room full of ornate carvings. It\'s about 30 feet long, 15 in either direction, and is 10 ft wide.\nThere is a long dinner table taking up nearly the entire length of the room. Two locked boxes sit on the table in front of you. One with a $ engraved on it and the other a house. Both have 4 dials all set to 0.\nTo your right is the kitchen, the left is a bedroom, ahead is a beautiful lake, and behind you is a path into the woods.', [])
